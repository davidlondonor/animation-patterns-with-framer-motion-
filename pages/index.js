...
export default function Home() {
	return (
		<div className={styles.container}>
			<Head>
				<title>Probando Framer Motionp</title>
			...
			{/* <AnimatePresence animate={false}>
				...
				>
					...
					<div>
						...
						>
							<path
								d="M203.652,241.068c-33.646,0-61.019,27.371-61.019,61.016c0,33.646,27.371,61.019,61.019,61.019
			...
			C237.183,320.572,222.146,335.617,203.652,335.617z"
							/>
							<path
								d="M203.652,174.603c-40.578,0-78.728,15.81-107.42,44.503c-5.367,5.367-5.367,14.064,0,19.432
			...
			C282.383,190.411,244.236,174.603,203.652,174.603z"
							/>
							<path
								d="M47.832,170.696c-5.369,5.368-5.369,14.064,0,19.433c5.361,5.368,14.064,5.368,19.434,0
			...
			c5.369-5.368,5.369-14.064,0-19.433C273.56,84.778,133.75,84.778,47.832,170.696z"
							/>
							<path
								d="M403.285,126.898c-53.328-53.326-124.223-82.691-199.633-82.691S57.346,73.572,4.027,126.898
			...
			>
				<AnimatePresence>
					...
					<motion.li initial={{ opacity: 1 }} animate={{ opacity: 1 }}>
						2
					</motion.li>
					<motion.li initial={{ opacity: 2 }} animate={{ opacity: 1 }}>
						3
					</motion.li>
				</AnimatePresence>
			</ul> */}
